        ...
        <div class="p-4">
            ...
            <div class="mb-4 grid grid-cols-2 gap-2 text-xs sm:text-sm">
                ...
                <div class="flex items-center gap-1.5 text-gray-600">
                    ...
                    <span class="truncate">{{ number_format($car->mileage_km) }} km</span>
                </div>
                ...
                <div class="flex items-center gap-1.5 text-gray-600">
                    ...
                    <span class="truncate">{{ ucfirst($car->fuel_type ?? '-') }}</span>
                </div>
